class Platformer extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.tilemapTiledJSON("platformer-level-1", "platformer-level-1.json");
    ...
    create() {
        ...
        this.physics.add.overlap(my.sprite.player, this.endLevelGroup, () => {
            ...
            this.add.text(this.cameras.main.midPoint.x - 190, this.cameras.main.midPoint.y - 150, "Press R to reset", {
                fontSize: '32px',
                fill: '#ffffff'
            }).setOrigin(0.5);
            this.add.text(this.cameras.main.midPoint.x + 190, this.cameras.main.midPoint.y - 150, "Press E to continue", {
                fontSize: '32px',
                fill: '#ffffff'
            }).setOrigin(0.5);
